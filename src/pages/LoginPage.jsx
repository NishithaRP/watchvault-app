...
import { Film, Eye, EyeOff, Tv, BookOpen, ArrowLeft } from 'lucide-react'
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', pointerEvents: 'none' }}>
        <div style={{
          position: 'absolute', top: '-20%', right: '-10%', width: '600px', height: '600px', borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(230,57,70,0.08) 0%, transparent 70%)'
        }} />
        <div style={{
          position: 'absolute', bottom: '-20%', left: '-10%', width: '500px', height: '500px', borderRadius: '50%',
        ...
        {[Film, Tv, BookOpen].map((Icon, i) => (
          <Icon key={i} size={24} style={{
            position: 'absolute', top: `${20 + i * 30}%`, left: `${5 + i * 15}%`,
            color: 'rgba(255,255,255,0.04)', transform: `rotate(${i * 15}deg)`
          }} />
        ))}
      </div>
      ...
      <div style={{ width: '100%', maxWidth: '420px', animation: 'fadeIn 0.4s ease' }}>
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          <div style={{
            ...
            width: '56px', height: '56px', borderRadius: '14px', background: 'var(--accent)',
            marginBottom: '16px', boxShadow: '0 0 30px rgba(230,57,70,0.4)'
          }}>
        ...
        <div className="card" style={{ padding: '32px' }}>
          ...
          {mode === 'reset_sent' ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <button className="btn btn-secondary" onClick={() => switchMode('login')}
            ...
            <div>
              <button onClick={() => switchMode('login')} style={{
                ...
                cursor: 'pointer', color: 'var(--text-muted)', fontSize: '13px', marginBottom: '20px',
